...
class PlatformWidgetNative extends StatelessWidget {
  const PlatformWidgetNative({
    Key key,
  ...
  Widget build(context) {
    switch (defaultTargetPlatformNative) {
      ...
      default:
        assert(false, 'Unexpected platform $defaultTargetPlatformNative');
        return null;
    }
  }
}

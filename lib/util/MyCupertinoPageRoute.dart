...
final DecorationTween _kGradientShadowTween = DecorationTween(
  ...
  end: _CupertinoEdgeShadowDecoration.none
);
...
class MyCupertinoPageRoute<T> extends PageRoute<T> {
  ...
  /// The title string of the previous [MyCupertinoPageRoute].
  ///
  ...
  void didChangePrevious(Route<dynamic> previousRoute) {
    final String previousTitleString = previousRoute is MyCupertinoPageRoute
        ? previousRoute.title
        : null;
  ...
  bool canTransitionFrom(TransitionRoute<dynamic> previousRoute) {
    return previousRoute is MyCupertinoPageRoute;
  }

  @override
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    // Don't perform outgoing animation if the next route is a fullscreen dialog.
    return nextRoute is MyCupertinoPageRoute;
  }
  ...
  ///
  /// Used by [MyCupertinoPageRoute.buildTransitions].
  ///
  /// This method can be applied to any [PageRoute], not just
  /// [MyCupertinoPageRoute]. It's typically used to provide a Cupertino style
...
///
/// This is created by a [MyCupertinoPageRoute] in response from a gesture caught
...
Future<T> showCupertitnoDialog<T>({
  @required BuildContext context,
  @required WidgetBuilder builder,
}) {
  assert(builder != null);

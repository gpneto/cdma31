...
class SoundPlayerUI extends StatefulWidget {
  ...
  SoundPlayerUI.fromLoader(OnLoad onLoad,
      ...
      bool enabled = true,
      AudioFocus audioFocus = AudioFocus.requestFocusAndStopOthers})
      : _onLoad = onLoad,
  ...
  State<StatefulWidget> createState() {
    return SoundPlayerUIState(_track, _onLoad, _audioFocus, enabled: _enabled);
  }
}
...
class SoundPlayerUIState extends State<SoundPlayerUI> {
  ...
  ///
  SoundPlayerUIState(this._track, this._onLoad, this._audioFocus, {bool enabled,})
    ...
    _player.openAudioSessionWithUI(focus: _audioFocus).then( (_){_setCallbacks();});
  }
